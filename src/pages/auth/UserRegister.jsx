    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-3xl shadow-2xl overflow-hidden">
        <div className="p-8 bg-temple-red text-white text-center">
          ...
          <h1 className="text-2xl font-serif font-bold">Devotee Registration</h1>
          <p className="text-white/70 text-sm mt-2">Create an account for personalized temple services</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          ...
          <p className="text-center text-sm text-gray-500">
            ...
            <Link to="/login" className="text-temple-red font-bold hover:underline">Sign In</Link>
          </p>
        </form>
      </div>
    </div>
